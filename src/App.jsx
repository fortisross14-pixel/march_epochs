...
export default function App(){
  ...
  function eligibleArtifactsForUnit(unitId){
    return Object.values(ITEMS).filter(item=>item.slot==='unit'&&(meta.inventory[item.id]||0)>0&&itemEligibleForUnit(item,unitId))
  }
